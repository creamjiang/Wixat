 ...
 */
public class WixatCreateServlet extends HttpServlet {

	private static final Logger Log = LoggerFactory.getLogger(WixatCreateServlet.class);
	...
	public void init(ServletConfig servletConfig) throws ServletException {
        ...
        AuthCheckFilter.addExclude("wixat/create");
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
			...
			if(plugin.exists(phone)){
				out.println("UserAlreadyExistsException");
			}else{
				if(plugin.create(phone, plugin.decrypt(password))){
					out.println(phone);
				}else{
					out.println("AccountCreationException");
				}
			}
		}catch (Exception e){
	...
	public void destroy() {
        ...
        AuthCheckFilter.removeExclude("wixat/create");
    }
