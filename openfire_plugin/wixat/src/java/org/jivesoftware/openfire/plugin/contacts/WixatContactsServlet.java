 ...
 */
public class WixatContactsServlet extends HttpServlet {

	private static final Logger Log = LoggerFactory.getLogger(WixatContactsServlet.class);
	...
	public void init(ServletConfig servletConfig) throws ServletException {
        ...
        AuthCheckFilter.addExclude("wixat/contacts");
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String phonesEncrypted = request.getParameter("phones");
        ...
        try{
			...
			String[] phones = plugin.decrypt(phonesEncrypted).split(",");
			String result = "";
			//out.println(plugin.decrypt(phonesEncrypted));
			...
			out.print(plugin.encrypt(result));
	...
	public void destroy() {
        ...
        AuthCheckFilter.removeExclude("wixat/contacts");
    }
