...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public static class DialogAction extends AbstractAction {
        ...
        public DialogAction(FragmentActivity context, DialogFragment dialog, int drawable) {
            super(drawable);
            mContext = context;
            mDialog = dialog;
        }
        ...
        public void performAction(View view) {
            try {
            	//FragmentActivity fm = (FragmentActivity)mContext.getSupportFragmentManager();
            	//dialog.show(fm, "listDialogFragment");
            	mDialog.show(mContext.getSupportFragmentManager(), "listDialogFragment");
            } catch (ActivityNotFoundException e) {
                Toast.makeText(mContext,
                        mContext.getText(R.string.actionbar_activity_not_found),
                        Toast.LENGTH_SHORT).show();
